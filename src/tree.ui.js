                ...
                children:[
                  {
                    'id':'photos',
                    type:UIList,
                    itemTemplate:"<div style='padding-top:15px;padding-right:15px'><img src='<%= item.name %>' style='width:138px;height:<%= parseInt(parseInt(item.height,10)*(138/parseInt(item.width,10))) %>px;'></div>",
                    autoShow:true,
